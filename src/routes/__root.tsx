...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Live 1-on-1 and small group Arabic classes designed for English-speaking kids. Learn with patient, certified Arabic teachers at ArabiyatLearn." },
      { name: "author", content: "ArabiyatLearn" },
      { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
      { name: "theme-color", content: "#0C3E35" },
      { property: "og:site_name", content: "ArabiyatLearn" },
      { property: "og:title", content: "ArabiyatLearn — Arabic Made Simple for Kids" },
      { property: "og:description", content: "Live 1-on-1 and small group Arabic classes designed for English-speaking kids." },
      ...
      { name: "twitter:creator", content: "@arabiyatlearn" },
      { name: "google-site-verification", content: "googled1dbb01cad8a0c77" },
    ],
