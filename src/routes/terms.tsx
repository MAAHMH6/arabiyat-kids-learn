...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions — Arabiyat Learning" },
      { name: "description", content: "Terms of use for Arabiyat Learning recorded Arabic courses." },
      { property: "og:title", content: "Terms & Conditions — Arabiyat Learning" },
...
const sections = [
  ...
  { h: "Content ownership", p: "All lesson videos, worksheets and materials remain the property of Arabiyat Learning. Sharing, downloading for redistribution or reselling is not permitted." },
